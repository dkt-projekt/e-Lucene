...
public class TemporalNormalizationTokenFilter extends TokenFilter {
     ...
     * this.input.
     */
	public TemporalNormalizationTokenFilter(TokenStream tokenStream) {
        super(tokenStream);
    }
    ...
    //TODO, normaliyation should be included here.
